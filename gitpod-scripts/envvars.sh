...
COREURL="https://github.com/LibreOffice/core.git"

ONLINEREPODIR=online
ONLINE_TARBALL_FNAME=${ONLINEREPODIR}-src.tar.gz
ONLINEDIR=${WORKSPACE}/${ONLINEREPODIR}
ONLINEURL="https://github.com/CollaboraOnline/online.git"
...
ONLINE_CONFIG_CMD="./configure CC=clang CXX=clang++ --prefix=/tmp/online-cache --enable-silent-rules --with-lokit-path=${COREDIR}/include --with-lo-path=${COREDIR}/instdir --enable-debug --enable-cypress --disable-setcap"
